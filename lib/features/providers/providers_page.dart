...
class _ProvidersPageState extends State<ProvidersPage> {
  ...
  ApiProviderConfig? _readConfig({bool requireModel = true}) {
    ...
    return ApiProviderConfig(
      ...
      model: requireModel
          ? model.text.trim()
          : (model.text.trim().isEmpty ? 'placeholder' : model.text.trim()),
          ...
          builder: (_) => SafeArea(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => ListTile(
                ...
                trailing: model.text == models[index]
                    ? const Icon(Icons.check_rounded, color: TavoPalette.jade)
                    : null,
                onTap: () {
          ...
          child: Column(
            ...
            children: [
              ...
              if (status != null) ...[
                ...
                Text(
                  status!,
                  style: const TextStyle(color: TavoPalette.jade, fontSize: 12),
                ),
              ],
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: loading ? null : _models,
        ...
        const GlassCard(
          child: Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  'API Key 写入 iOS Keychain / Android Keystore 对应的安全存储；普通配置只保存 URL、模型和非敏感 Header。',
                  style: TextStyle(color: TavoPalette.muted),
                ),
              ),
            ],
