...
class SearchRepository {
  const SearchRepository({SecureStore secureStore = const SecureStore()}) : _secureStore = secureStore;
  ...
  Future<SearchConfig?> load() async {
    ...
    final backend = SearchBackend.values.where((e) => e.name == rawBackend).firstOrNull;
