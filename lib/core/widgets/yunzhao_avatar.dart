  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(colors: [TavoPalette.gold, TavoPalette.sakura, TavoPalette.violet]),
        boxShadow: showGlow ? [BoxShadow(color: TavoPalette.violet.withValues(alpha: .34), blurRadius: size * .45)] : null,
      ),
      child: ClipOval(
        child: Image.asset(
